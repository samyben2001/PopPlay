...
router.register('mediaQuizReportType', views.MediaQuizReportTypeViewSet, basename='create-mediaQuizReportType')
router.register('mediaQuizReport', views.MediaQuizReportViewSet, basename='create-mediaQuizReport')
